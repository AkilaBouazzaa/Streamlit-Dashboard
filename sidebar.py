...
def setup_sidebar():
    html_content = """
    <div style="text-align: center;">
        <h1 style="color:black;">CNAS Dashboard</h1>
    </div>
    """
    st.sidebar.markdown('<div style= "align: center; width: 10px;">', unsafe_allow_html=True)
...
def setup_mlops_sidebar():
    ...
    model_options = ["Random Forest", "Decision Tree", "Logistic Regression","Gradient Boost" ,"XGBoost","Naive Bayes"]  # Example model names
